  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile: Bottom sheet
        "left-0 right-0 bottom-0 max-h-[90vh] translate-y-[0] data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom rounded-t-lg p-4 pt-2",
        // Desktop: Center modal
        "sm:left-[50%] sm:top-[50%] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:bottom-auto sm:right-auto sm:p-6",
